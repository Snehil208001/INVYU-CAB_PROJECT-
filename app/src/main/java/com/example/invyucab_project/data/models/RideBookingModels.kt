...
data class CreateRideRequest(
    ...
    // ✅ NEW: Fields for Courier & Scheduling
    @Json(name = "scheduled_time") val scheduledTime: Long? = null,
    @Json(name = "is_courier") val isCourier: Boolean? = false,
    @Json(name = "receiver_name") val receiverName: String? = null,
...
data class RideHistoryItem(
    ...
    // ✅ ADDED: To distinguish between Cab and Courier in history
    @Json(name = "is_courier") val isCourier: Boolean? = false
)
