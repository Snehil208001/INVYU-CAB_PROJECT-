...
import com.example.invyucab_project.mainui.managedriversscreen.ui.ManageDriversScreen
import com.example.invyucab_project.mainui.courierscreen.ui.CourierDetailsScreen
import com.example.invyucab_project.mainui.billscreen.ui.BillScreen
...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(
            route = Screen.CourierDetailsScreen.route,
            arguments = listOf(
                navArgument("pickupPlaceId") { type = NavType.StringType },
                navArgument("pickupDesc") { type = NavType.StringType },
                navArgument("dropPlaceId") { type = NavType.StringType },
                navArgument("dropDesc") { type = NavType.StringType },
                navArgument("scheduleTime") { type = NavType.LongType; defaultValue = 0L }
            )
        ) { backStackEntry ->
            val pickupPlaceId = backStackEntry.arguments?.getString("pickupPlaceId") ?: ""
            val pickupDesc = backStackEntry.arguments?.getString("pickupDesc") ?: ""
            val dropPlaceId = backStackEntry.arguments?.getString("dropPlaceId") ?: ""
            val dropDesc = backStackEntry.arguments?.getString("dropDesc") ?: ""
            val scheduleTime = backStackEntry.arguments?.getLong("scheduleTime") ?: 0L
        ...
        composable(
            ...
            arguments = listOf(
                ...
                navArgument("isCourier") { type = NavType.BoolType; defaultValue = false },
                navArgument("receiverName") { type = NavType.StringType; defaultValue = "" },
                navArgument("receiverPhone") { type = NavType.StringType; defaultValue = "" },
                navArgument("packageType") { type = NavType.StringType; defaultValue = "" },
                navArgument("scheduleTime") { type = NavType.LongType; defaultValue = 0L }
            )
        ) {
        ...
        composable(
            ...
            // ✅ FIX: Safely handle null arguments by providing a default value string
            val pickupAddress = backStackEntry.arguments?.getString("pickupAddress") ?: ""
            val dropAddress = backStackEntry.arguments?.getString("dropAddress") ?: ""
